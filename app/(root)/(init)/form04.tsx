...
import Animated, { useSharedValue, useAnimatedStyle, withTiming } from 'react-native-reanimated'; // Use only react-native-reanimated
...
const Form04 = () => {
    ...
    //TODO: REVISAR COMPORTAMIENTO DEL TECLADO
            ...
            <View>
                ...
                {enableEdit && (
                    <Animated.View
                        ...
                        <TextInput
                            className="h-44 text-white w-full font-ralewaySemiBold break-words border-2 border-white rounded-md p-2"
                            value={medicalDetail}
                            multiline={true}
