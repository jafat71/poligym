...
import { DoubleNumericInputForm, NumericInputForm } from '@/types/interfaces/ui';
import React from 'react';
import { Text, TextInput, View } from 'react-native';
import IconButton from '../buttons/IconButton';
import { Ionicons } from '@expo/vector-icons';

const DoubleNumericInputInitForm = (
    {
        title,
        icon,
        inputKeyboardType,
        ...
        subFn,
        addFn,
        SecinputKeyboardType,
        SecaddFn,
        SecinputOnChangeText,
        SecinputPlaceholder,
        SecinputValue,
        SecsubFn,
        Secenabled,
        ...
        <View className='flex flex-col items-center w-full max-w-md mx-auto' >
            ...
            <View className={`w-full mt-2 border-[1px] 
                ...
                <View className='flex flex-row items-center '>
                    ...
                    <View className={`flex- 1 border-x-[1px]  border-${isDark ? "darkGray-400" : "darkGray-500"}`}>
                    ...
                    <TextInput
                        className={`flex-1 p-2 
                            ...
                            ${alert ? "bg-redEPN-300 text-white" : ""}
                            ml-2 font-ralewayBold`}
                        placeholder={SecinputPlaceholder}
                        keyboardType={SecinputKeyboardType}
                        placeholderTextColor="#a6a6a6"
                        defaultValue=''
                        value={SecinputValue}
                        onChangeText={SecinputOnChangeText}
                        secureTextEntry={SecinputSecure}
                        editable={Secenabled}
...
export default DoubleNumericInputInitForm;
